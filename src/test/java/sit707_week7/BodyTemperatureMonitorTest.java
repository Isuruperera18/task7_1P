...
public class BodyTemperatureMonitorTest {
    ...
    public void testReportTemperatureReadingToCloud() {
        ...
        TemperatureReading reading = new TemperatureReading(36.5); // Should use the correct constructor
        ...
        System.out.println("Temperature reading sent to cloud: " + reading.getBodyTemperature());
    ...
    public void testInquireBodyStatusNormalNotification() {
        ...
        System.out.println("Notification sent to customer for normal status.");

        Mockito.verify(notificationSender).sendEmailNotification(
    ...
    public void testInquireBodyStatusAbnormalNotification() {
        ...
        System.out.println("Emergency notification sent to family doctor for abnormal status.");

        Mockito.verify(notificationSender).sendEmailNotification(
            Mockito.any(FamilyDoctor.class), 
            Mockito.eq("Emergency!")
        );
    }
    ...
    public void testReadTemperatureWithoutSensor() {
        BodyTemperatureMonitor monitor = new BodyTemperatureMonitor(null, null, null);
    ...
    public void testReadTemperature() {
        ...
        double temperature = monitor.readTemperature();
        Assert.assertEquals(36.5, temperature, 0.1);  // Tolerance for floating-point comparisons
    }
